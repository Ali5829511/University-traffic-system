...
```
🔴 تحذير أمني حرج / CRITICAL SECURITY WARNING:
⚠️ النظام يأتي مع كلمات مرور افتراضية ضعيفة
⚠️ يجب تغييرها خلال الساعة الأولى بعد النشر
⚠️ استخدم كلمات مرور قوية وفريدة (انظر POST_DEPLOYMENT_SECURITY_CHECKLIST.md)

للاطلاع على بيانات الدخول الافتراضية:
راجع: docs/SECURITY.md (القسم 2)

⚠️ لأسباب أمنية، تم نقل بيانات الدخول الافتراضية إلى ملف الأمان
⚠️ For security reasons, default credentials moved to security documentation
```
